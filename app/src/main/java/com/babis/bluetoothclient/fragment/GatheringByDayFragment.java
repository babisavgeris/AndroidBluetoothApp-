...
public class GatheringByDayFragment extends Fragment {

    private static final String FRAGMENT_NAME = GatheringByDayFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_gathering_by_day, container, false);
        initUI();
        return rootView;
    }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i=0; i<jsonArray.length(); i++){
                                ...
                                //String day = jsonObject.getString("day").trim();
                            ...
                            chart.getDescription().setText("Gathering in countries by day");
    ...
    public String toString() {
        return GatheringByDayFragment.class.getSimpleName();
    }
}