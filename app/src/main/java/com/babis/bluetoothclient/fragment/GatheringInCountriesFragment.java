...
public class GatheringInCountriesFragment extends Fragment {

    private static final String FRAGMENT_NAME = GatheringInCountriesFragment.class.getSimpleName();
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_gathering_in_countries, container, false);
        initUI();
        return rootView;
    }

    private void initUI() {
        chart = (HorizontalBarChart) rootView.findViewById(R.id.chartGatheringInCountries);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            BarDataSet set1;
                            set1 = new BarDataSet(yVals1, "Countries");
    ...
    public String toString() {
        return GatheringInCountriesFragment.class.getSimpleName();
    }
}