...
public class GatheringInCitiesFragment extends Fragment {

    private static final String FRAGMENT_NAME = GatheringInCitiesFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_gathering_in_cities, container, false);
        initUI();
        return rootView;
    }

    private void initUI() {
        chart = (HorizontalBarChart) rootView.findViewById(R.id.chartGatheringInCities);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            chart.getDescription().setText("Gathering in cities");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error.networkResponse.statusCode == 403){
                    ...
                    Toast.makeText(getActivity().getApplicationContext(), "Data have not been sent. \nUnknown error",
    ...
    public String toString() {
        return GatheringInCitiesFragment.class.getSimpleName();
    }
}